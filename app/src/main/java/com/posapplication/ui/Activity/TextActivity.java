...
import com.posapplication.Util.BluetoothUtil;
import com.posapplication.Util.Const;
import com.posapplication.Util.ESCUtil;
import com.posapplication.Util.SunmiPrintHelper;
...
public class TextActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mEditText = findViewById(R.id.printET);

        mLinearLayout = findViewById(R.id.text_all);
        mLayout = findViewById(R.id.text_set);
        Intent intent = getIntent();
        printtext = intent.getStringExtra(Const.PRINT_TEXT);
//        mEditText.setText(printtext);
